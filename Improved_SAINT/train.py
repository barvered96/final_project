...
def perform_nested_cv(dataset):
    ...
    for train_split, test_split in outer_kf.split(train, Y):
        ...
        lrs = [0.001, 0.0001]
        eps = [0.9, 0.99]
        for lr in lrs: # Starting hyper parameter tuning
            optimizer.defaults['lr'] = lr
            for ep in eps:
                optimizer.defaults['eps'] = ep
                print("Starting HyperParameter tuning using lr", lr, "and epsilon", ep)
                cv_inside = 1
                for inner_train, rest_train in inner_kf.split(X_train['data']): # Inside 10 cross validation
    ...
    #Printing results to excel file
    ...
    data = {
        ...
        "Algorithm Name": ['SAINT+Improve', 'SAINT+Improve', 'SAINT+Improve', 'SAINT+Improve', 'SAINT+Improve',
                           'SAINT+Improve', 'SAINT+Improve', 'SAINT+Improve', 'SAINT+Improve', 'SAINT+Improve'],
    ...
    pd.DataFrame(data).to_excel('10.xlsx')


if __name__ == '__main__':
    perform_nested_cv('baseball')
